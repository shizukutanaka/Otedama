# Enhanced Multi-stage Dockerfile for Otedama Mining Pool
...
COPY --chown=otedama:otedama workers ./workers/
COPY --chown=otedama:otedama services ./services/
COPY --chown=otedama:otedama web ./web/
COPY --chown=otedama:otedama api ./api/
COPY --chown=otedama:otedama config ./config/
COPY --chown=otedama:otedama *.md ./
...
echo "🚀 Otedama Mining Pool v0.6.1-enhanced"
echo "====================================="
