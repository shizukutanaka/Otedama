...
const (
	...
	// Same rationale as stratumv1's 5-minute per-line deadline. 5 minutes
	// is safe: real SV2 pools push new jobs on every template update, far
	// more often than the ~10-minute block interval.
