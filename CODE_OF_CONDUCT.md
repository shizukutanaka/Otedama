...
Otedama project and community a harassment-free experience for everyone,
...
pull requests, discussions, and any chat spaces operated by the project —
and also applies when an individual is officially representing the project
in public spaces.

## Enforcement Responsibilities

The project maintainer is responsible for clarifying and enforcing this code.
The maintainer will take appropriate and fair corrective action in response
...
reported by opening a private report via GitHub Security Advisories:
