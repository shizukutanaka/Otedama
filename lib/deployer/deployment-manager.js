...
export class DeploymentManager extends EventEmitter {
  constructor(options = {}) {
    ...
    this.options = {
      ...
      stopCommand: options.stopCommand || 'node scripts/graceful-shutdown.js',
  ...
  async runCommand(command, options = {}) {
    ...
    return new Promise((resolve, reject) => {
      ...
      // Use execFile for safer execution when possible
  ...
  async startInstance(port) {
    ...
    // Start instance in background safely
    const [cmd, ...args] = command.split(' ');
