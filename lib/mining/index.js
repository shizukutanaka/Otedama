...
// Advanced mining components
export { HardwareAutoDetector, HardwareType } from './hardware-auto-detector.js';
export { HardwareOptimizer, OptimizationProfile } from './hardware-optimizer.js';
export { ProfitCalculator, CoinConfigs } from './profit-calculator.js';
export { PoolSwitcher, PoolConfig, ExchangeStrategy } from './pool-switcher.js';
export { DistributedValidator, ValidationRequestType, ConsensusMechanism } from './distributed-validator.js';
