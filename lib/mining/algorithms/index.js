...
algorithmRegistry.register('cryptonight-lite', CryptoNight);
algorithmRegistry.register('cryptonight-heavy', CryptoNight);
...
export const MINING_ALGORITHMS = {
  ...
  PROGPOW: { name: 'progpow', currency: 'CFX' },
  CRYPTONIGHT: { name: 'cryptonight', currency: 'XMR' },
  CRYPTONIGHT_LITE: { name: 'cryptonight-lite', currency: 'AEON' },
  CRYPTONIGHT_HEAVY: { name: 'cryptonight-heavy', currency: 'RYO' }
};

// Export individual algorithm classes
export { SHA256, Scrypt, Ethash, RandomX, KawPow, ProgPoW, CryptoNight };
