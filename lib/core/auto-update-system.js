...
const logger = createStructuredLogger('auto-update');
...
class AutoUpdateSystem extends EventEmitter {
  constructor(options = {}) {
    ...
    this.options = {
      ...
      updateUrl: options.updateUrl || 'https://api.github.com/repos/shizukutanaka/Otedama/releases',
      githubRepo: options.githubRepo || 'shizukutanaka/Otedama',
