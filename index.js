 ...
 * - BTC Address: 1GzHriuokSrZYAZEEWoL7eeCCXsX3WyLHa (UNCHANGEABLE)
...
const SYSTEM_CONSTANTS = Object.freeze({
  OPERATOR_BTC_ADDRESS: '1GzHriuokSrZYAZEEWoL7eeCCXsX3WyLHa', // IMMUTABLE - CANNOT BE CHANGED
  OPERATOR_FEE_RATE: 0.015, // 1.5% (OPERATIONAL FEE ONLY)
  POOL_FEE_RATE: 0.0, // 0% (REMOVED)
  TOTAL_FEE_RATE: 0.015, // 1.5% FIXED (OPERATIONAL FEE ONLY)
